		...
		case enumHCBoxOnly :
			{
				...
				Lputs( 0x0400u, "恒温箱:" );
				ShowFP32( 0x0407u, RunTemp, 0x0501u, "℃" );

				if      ( OutValue > 0.0f )
				{
					Lputs( 0x0600u, "加热: " );
					ShowFP32( 0x0606u, OutValue, 0x0601u, "% " );
				}
		...
		case enumHeaterOnly:
			{
				...
				if( state )
				{
					...
					{
						Lputs( 0x0600u, "输  出: " );
						ShowFP32( 0x0608u, OutValue, 0x0601u, "% " );
					}
					else
					{
						Lputs( 0x0600u, "输  出: " );
...
static	void	ShowTimeState ( enum enumSamplerSelect SamplerSelect, enum enumPumpSelect PumpSelect  )
{
	...
	//TODO:	2路同开不同关的时间不一样！！！
	Lputs ( 0x0400u, "当前次数:" );
	ShowI16U ( 0x040Bu, p->loops, 0x0500u, NULL );
	Lputs ( 0x0600u, "剩余时间:" );
	ShowTIME ( 0x060Bu, p->timer );
...
static	void	ShowPumpBefore( enum enumPumpSelect PumpSelect )
{
	...
	{
		Lputs ( 0x0200u, "温  度:" );
		ShowFP32 ( 0x0207u, get_Tr( PumpSelect ), 0x0602u, "℃" );
		Lputs ( 0x0400u, "压  力:" );
		ShowFP32 ( 0x0407u, get_Pr( PumpSelect ), 0x0602u, "kPa" );
		Lputs ( 0x0600u, "大气压:" );
		ShowFP32 ( 0x0607u, get_Ba(),             0x0602u, "kPa" );
	}
}
	...
	else
	{
		...
		switch ( PumpSelect )
		{
			case PP_TSP: // TSP_KB120F
				...
				Lputs ( 0x0200u, "工况:" );
				ShowFP32    ( 0x0205u, flow, 0x0701u, "L/m" );
				Lputs ( 0x0400u, "标况:" );
				ShowFP32    ( 0x0405u, fstd, 0x0701u, "L/m" );
				Lputs ( 0x0600u, "输出:" );
				ShowPercent ( 0x0607u, OutValue );
				break;
			case PP_R24_A:
			case PP_R24_B:
			case PP_SHI_C:
			case PP_SHI_D:
				...
				Lputs ( 0x0400u, "                " );
				Lputs ( 0x0300u, "标况:" );
				ShowFP32    ( 0x0305u, fstd, 0x0703u, "L/m" );
				Lputs ( 0x0600u, "输出:" );
				ShowPercent ( 0x0606u, OutValue );
				break;
			default:
			case PP_AIR:
				break;
...
static	void	ShowSumCubage( enum enumPumpSelect PumpSelect )
{
	...
	switch (PumpSelect )
	{
		case PP_TSP: // TSP_KB120F
			Lputs ( 0x0200u, "工况体积:" );
			ShowFP32 ( 0x0209u, p->vd,       0x0600u, "L" );
			Lputs ( 0x0400u, "标况体积:" );
			ShowFP32 ( 0x0409u, p->vnd,      0x0600u, "L" );
			Lputs ( 0x0600u, "采样时间:" );
			ShowTIME ( 0x060Bu, p->sum_time );
			break;
		case PP_R24_A:
		case PP_R24_B:
		case PP_SHI_C:
		case PP_SHI_D:
			Lputs ( 0x0300u, "标 况:" );
			ShowFP32 ( 0x0306u, p->vnd,  0x0802u, "L" );
			Lputs ( 0x0600u, "采样时间:" );
			ShowTIME ( 0x060Bu, p->sum_time );
			break;
		case PP_AIR:
			{
				Lputs ( 0x0200u, "累积时间:" );
				ShowTIME ( 0x020Bu, p->sum_time );
				Lputs ( 0x0400u, "体 积Ⅰ:" );
				ShowFP32 ( 0x0408u, (uint32_t)( p->sum_time * Configure.AIRSetFlow[Q_PP1] ) * 0.1f ,  0x0602u, "L" );
				Lputs ( 0x0600u, "体 积Ⅱ:" );
				ShowFP32 ( 0x0608u, (uint32_t)( p->sum_time * Configure.AIRSetFlow[Q_PP2] ) * 0.1f ,  0x0602u, "L" );
			}
			break;
	}
}
...
static	void	ShowHCBox( void )
{
	switch ( Configure.HeaterType )
	{
		...
		case enumHCBoxOnly:
			...
			Lputs ( 0x0400u, "输出:" );
			ShowFP32 ( 0x0405u, get_HCBoxOutput(),   0x0501u, "% " );
			Lputs ( 0x0600u, "风扇:" );
			ShowI16U ( 0x0605u, get_HCBoxFanSpeed(), 0x0500u, "RPM" );
			break;
		case enumHeaterOnly:
			Lputs ( 0x0000u, "加热器");
			Lputs ( 0x0300u, "温度:" );
			ShowFP32 ( 0x0305u, get_HeaterTemp(),     0x0602u, "℃" );
			Lputs ( 0x0600u, "输出:" );
			ShowFP32 ( 0x0605u, get_HeaterOutput(),   0x0501u, "% " );
			break;
	...
	while ( ( opt_exit != option ) && Sampler_isRunning( SamplerSelect ))
	{
		...
		switch ( option )
		{
			case opt_qt_1:
				...
				break;
			case opt_qt_2:
				ShowPumpBefore( PumpSelect );
				break;
			case opt_qt_3:
				ShowPumpRunFlow( PumpSelect );
				break;
			case opt_qt_4:
				ShowSumCubage( PumpSelect );
				break;
			default:
				break;
		}
...
void	SamplerTypeSwitch( void )
{
	...
	switch ( SamplerSelect )
	{
		case Q_ALL:
			...
			if ( hasPumpTSP )
			{
				SamplerSelect = Q_TSP;	 //lint	-fallthrough
				break;
			}
		...
		case Q_TSP:
			...
			if ( hasPumpR24 )
			{
				SamplerSelect = Q_R24;	 //lint	-fallthrough
				break;
			}
		...
		case Q_R24:
			...
			if ( hasPumpSHI )
			{
				SamplerSelect = Q_SHI;	 //lint	-fallthrough
				break;
			}
		...
		case Q_SHI:
			...
			if ( hasPumpAIR )
			{
				SamplerSelect = Q_AIR;	 //lint	-fallthrough
				break;
			}
