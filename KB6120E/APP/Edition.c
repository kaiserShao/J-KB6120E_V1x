...
//   Lputs( 0x0000u, szNameIdent[Configure.InstrumentName] );
	...
	Lputs( 0x0500u, "编号:" );
	ShowFP32( 0x0507u, Configure.ExNum, 0x0700u, NULL );
}
static	void	ShowEdition_NoName2( void )
{
	...
	Lputs( 0x0600u, "编号:" );
	ShowFP32( 0x0607u, Configure.ExNum, 0x0700u, NULL );
}
...
void	ConfigureLoad_KB6120A( void )
{
	...
	Configure.PumpType[PP_TSP  ] = enumOrifice_1;
	Configure.SetFlow[PP_TSP  ]  = 1000u;	//	粉尘 采样流量 100.0 L/m
	Configure.PumpType[PP_R24_A] = enumPumpNone;
	Configure.SetFlow[PP_R24_A]  =  200u;	//	日均1采样流量 0.200 L/m
	Configure.PumpType[PP_R24_B] = enumPumpNone;
	Configure.SetFlow[PP_R24_B]  =  200u;	//	日均2采样流量 0.200 L/m
	Configure.PumpType[PP_SHI_C] = enumPumpNone;
	Configure.SetFlow[PP_SHI_C]  =    5u;	//	时均1采样流量 0.5 L/m
	Configure.PumpType[PP_SHI_D] = enumPumpNone;
	Configure.SetFlow[PP_SHI_D]  =    5u;	//	时均2采样流量 0.5 L/m
	Configure.PumpType[PP_AIR  ] = enumOrifice_1;
	Configure.SetFlow[PP_AIR  ]  =  500u;	//	大气 流量 0.5 L/m
...
void	ConfigureLoad_KB2400HL( void )
{
	...
	Configure.PumpType[PP_TSP  ] = enumPumpNone;
	Configure.SetFlow[PP_TSP  ]  = 1000u;	//	粉尘  采样流量 100.0 L/m
	Configure.PumpType[PP_R24_A] = enumPumpNone;
	Configure.SetFlow[PP_R24_A]  =  200u;	//	日均1 采样流量 0.200 L/m
	Configure.PumpType[PP_R24_B] = enumPumpNone;
	Configure.SetFlow[PP_R24_B]  =  200u;	//	日均2 采样流量 0.200 L/m
	Configure.PumpType[PP_SHI_C] = enumOrifice_1;
	Configure.SetFlow[PP_SHI_C]  =    5u;	//	时均1 采样流量 0.5 L/m
	Configure.PumpType[PP_SHI_D] = enumOrifice_1;
	Configure.SetFlow[PP_SHI_D]  =    5u;	//	时均2 采样流量 0.5 L/m
	Configure.PumpType[PP_AIR  ] = enumPumpNone;
	Configure.SetFlow[PP_AIR  ]  =  500u;	//	大气 流量 0.5 L/m
...
void	ConfigureLoad_KB6120AD2( void )
{
	...
	Configure.PumpType[PP_TSP  ] = enumOrifice_1;
	Configure.SetFlow[PP_TSP  ]  = 1000u;	//	粉尘  采样流量 100.0 L/m
	Configure.PumpType[PP_R24_A] = enumOrifice_1;
	Configure.SetFlow[PP_R24_A]  =  200u;	//	日均1 采样流量 0.200 L/m
