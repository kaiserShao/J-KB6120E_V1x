...
static	void	menu_Clean_SumTime( void )
{
	...
	do
	{
		...
		Lputs( 0x0000u, "粉尘:" );
		ShowFP32( 0x0005u, PumpSumTimeLoad( PP_TSP ) / 60.0f, 0x0601u, "h" );
		Lputs( 0x0200u, "A:" );
		ShowFP32( 0x0202u, PumpSumTimeLoad( PP_R24_A ) / 60.0f, 0x0601u, NULL );
		Lputs( 0x0208u, "B:" );
		ShowFP32( 0x020Au, PumpSumTimeLoad( PP_R24_B ) / 60.0f, 0x0601u, NULL );
		Lputs( 0x0400u, "C:" );
		ShowFP32( 0x0402u, PumpSumTimeLoad( PP_SHI_C ) / 60.0f, 0x0601u, NULL );
		Lputs( 0x0408u, "D:" );
		ShowFP32( 0x040Au, PumpSumTimeLoad( PP_SHI_D ) / 60.0f, 0x0601u, NULL );
		Lputs( 0x0600u, "大气:" );
		ShowFP32( 0x0605u, PumpSumTimeLoad( PP_AIR ) / 60.0f, 0x0601u, NULL );
...
static	void	menu_Clean_FileNum( void )
{
	...
	do
	{
		...
		Lputs( 0x0000u, "粉尘:" );
		ShowI16U( 0x0009u, SampleSet[Q_TSP].FileNum, 0x0300u, NULL );
		Lputs( 0x0200u, "日均:" );
		ShowI16U( 0x0209u, SampleSet[Q_R24].FileNum, 0x0300u, NULL );
		Lputs( 0x0400u, "时均:" );
		ShowI16U( 0x0409u, SampleSet[Q_SHI].FileNum, 0x0300u, NULL );
		Lputs( 0x0600u, "大气:" );
		ShowI16U( 0x0609u, SampleSet[Q_AIR].FileNum, 0x0300u, NULL );
